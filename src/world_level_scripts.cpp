...
void world::run_script_on_init()
{
	if (name == "debug")
	{
		...
		dynamic_cast<entt_maincube*>(mainCube)->update_spatial_props(Vector3{ 0.0f, 0.0f, 0.0f }, Vector3{ 1.0f, 1.0f, 1.0f }, Vector3{ 0.0f, 0.0f, 45.0f });
		//dynamic_cast<entt_maincube*>(mainCube1)->update_spatial_props(Vector3{ 0.0f, 0.0f, 0.0f }, Vector3{ 1.0f, 1.0f, 1.0f }, Vector3{ 0.0f, 45.0f, 45.0f });
