...
void world::run_script_on_init()
{
	if (name == "debug")
	{
		...
		dynamic_cast<entt_maincube*>(mainCube)->update_spatial_props(Vector3{ 0.0f, 0.0f, 0.0f }, Vector3{ 1.0f, 1.0f, 1.0f }, Vector3{ 0.0f, 90.0f, 90.0f });
		dynamic_cast<entt_maincube*>(mainCube2)->update_spatial_props(Vector3{ 0.0f, -5.0f, 0.0f }, Vector3{ 1.0f, 1.0f, 1.0f }, Vector3{ 0.0f, 0.0f, 0.0f });
